                        ...
                        <tbody>
                            ...
                            <td>
                                <?php 
                                    ...
                                    echo $UsP['Nombre'];
                                    $conUs = ejecutarSQL::consultar("SELECT Apellido FROM cliente WHERE NIT='" . $order['NIT'] . "'");
                                    $UsP = mysqli_fetch_array($conUs, MYSQLI_ASSOC);
                                    echo "<p>" . $UsP['Apellido'] . "</p>";
                                    $conUs = ejecutarSQL::consultar("SELECT NombreCompleto FROM cliente WHERE NIT='" . $order['NIT'] . "'");
                                    $UsP = mysqli_fetch_array($conUs, MYSQLI_ASSOC);
                                    echo "<p>" . $UsP['NombreCompleto'] . "</p>";
                                    $conUs = ejecutarSQL::consultar("SELECT Direccion FROM cliente WHERE NIT='" . $order['NIT'] . "'");
                                    $UsP = mysqli_fetch_array($conUs, MYSQLI_ASSOC);
                                    echo "<p>" . $UsP['Direccion'] . "</p>";
                                    $conUs = ejecutarSQL::consultar("SELECT Telefono FROM cliente WHERE NIT='" . $order['NIT'] . "'");
                                    $UsP = mysqli_fetch_array($conUs, MYSQLI_ASSOC);
                                    echo "<p>" . $UsP['Telefono'] . "</p>";
                                    $conUs = ejecutarSQL::consultar("SELECT Email FROM cliente WHERE NIT='" . $order['NIT'] . "'");
                                    $UsP = mysqli_fetch_array($conUs, MYSQLI_ASSOC);
                                    echo "<p>" . $UsP['Email'] . "</p>";
                                ?>
                            </td>
                            ...
                            <td class="text-center">
                              <form action="process/delPedido.php" method="POST" class="FormCatElec" data-form="delete">
                                ...
                                <a href="ver.php?id=<?php print $item['id'] ?>" ><span class="glyphicon glyphicon-eye-open"></span>  </a>
                              </form>
                            </td>
                            </tr>
                            <?php
